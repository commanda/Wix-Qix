...
class Base(object):
    ...
    def __init__(self, x, y, z=0, color=(0.,0.,0.,1.), stroke=0, rotation=0):
        try :
            ...
            self.rect = FilledRect(x,y,1,1) # this inits x,y and loc as well
        self.visible = 1 #
        self.z = z 
...
class Circle(Base):
    ...
    def __init__(self, x=10, y=10, z=0, width=2, color=(0,0,0,1), stroke=0, rotation=0.0, style=GLU_FILL):
        ...
        self.rect = FilledRect(x, y, width, width)
        self.style = style
...
class Polygon(Base):
    def __init__(self, v, z=0, color=(0,0,0,1), stroke=0, rotation=0.0, style=0):
        ...
        self.rect = FilledRect(l+(r-l)*0.5, t+(b-t)*0.5, r-l, b-t)
...
if __name__=="__main__":
    ...
    l = PrimLine((10,299),(100,299),stroke=2,color=(0,0.,1.,1.))
    r = FilledRect(100, 100, 100, 200)
